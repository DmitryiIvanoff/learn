...
{
    public class ProjectListtSplitFileLoader : IProjectLoad
    {
        private List<SETI> _SETIlist = null;
        private readonly string _fileName = "";
        private LoadStatus _status = LoadStatus.None;
        public ProjectListtSplitFileLoader()
        {
            this._fileName = Kpo4162.Ivanov.Lib.AppGlobalSettings.dataFileName;
