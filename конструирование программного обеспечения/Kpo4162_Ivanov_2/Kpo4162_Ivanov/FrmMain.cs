...
namespace Kpo4162_Ivanov
{
    public partial class FrmMain : Form
    {
        ...
        {
            this.txtLogPath.Text = Kpo4162.Ivanov.Lib.AppGlobalSettings.logPath;
            this.txtDataFileName.Text = Kpo4162.Ivanov.Lib.AppGlobalSettings.dataFileName;
        }
        ...
        private void mnOpen_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //Kpo4162.Ivanov.Lib.IProjectListLoader Seti = new Kpo4162.Ivanov.Lib.ProjectListtSplitFileLoader(Kpo4162.Ivanov.Lib.AppGlobalSettings.dataFileName);
                //Seti.Execute();

                Kpo4162.Ivanov.Lib.IProjectListLoader Seti = new Kpo4162.Ivanov.Lib.ProjectTestListSplitFileLoader();
                Seti.Execute();
                setiList = Seti.SETIlist;
