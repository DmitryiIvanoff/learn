...
public class Dialog extends Thread{
    ...
    private static Stack deletedArray = new Stack();
    private static int top = -1;
    private String reader;
    private boolean exit = false;
    private static BufferedReader bf = new BufferedReader(new InputStreamReader(System.in));

    public static Stack getDeletedArray() {
        return deletedArray;
    }

    public static void setDeletedArray(Stack deletedArray) {
    ...
    public Dialog() {
        ...
        "\nВывод текущего состояния стека удаленных элементов на экран - \"8\"") ;
    }
    public void run(){
