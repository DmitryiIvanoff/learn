...
namespace Laba1
{
    public partial class Form1 : Form
    {
        ...
        {
            string connectionString = @"Data Source=(LocalDB)\v11.0;AttachDbFilename=c:\MY\legal\github\learn\базы данных\курсовая работа\Laba1\Laba1\Sport.mdf;Integrated Security=True;MultipleActiveResultSets=True";
